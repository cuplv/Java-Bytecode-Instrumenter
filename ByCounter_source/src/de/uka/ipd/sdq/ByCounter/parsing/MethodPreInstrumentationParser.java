...
public final class MethodPreInstrumentationParser extends MethodAdapter {
	...
	public MethodPreInstrumentationParser(
		...
		this.useRegions = this.instrumentationParameters.useRegionsForMethod(method);
...
//			MethodNode methodNode = (MethodNode)this.mv;
			...
			if(useRegions) {
				...
				// analyse
				log.info("Analysing method " + this.method.getCanonicalMethodName() + " for label blocks.");
