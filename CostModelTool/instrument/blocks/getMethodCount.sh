...
do 
   ...
   if [ "$#" -eq 1 ]
   then
     java -Xmx512M -Xss256M -jar $1 $line > log/methodCount.log
   elif [ "$#" -eq 2 ]
   then
     java -Xmx512M -Xss256M -jar $1 $2 $line > log/methodCount.log
   elif [ "$#" -eq 3 ]
   then
     java -Xmx512M -Xss256M -jar $1 $2 $3 $line > log/methodCount.log
   elif [ "$#" -eq 4 ]
   then	
     java -Xmx512M -Xss256M -jar $1 $2 $3 $4 $line > log/methodCount.log
   elif [ "$#" -eq 5 ]
   then
